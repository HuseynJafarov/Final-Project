    ...
    public class ProductDetailController : Controller
    {
        ...
        public async Task<ActionResult> Create(ProductDetailCreateVM createVM)
        {
            ...
            if (createVM.Photo != null)
            {
                ...
                string pathh = Helper.GetFilePath(_env.WebRootPath, "assets/images/products", fileName);
        ...
        public async Task<IActionResult> Edit(int id, ProductDetail detail)
        {
            try
            {
                ...
                if (detail.Photo != null)
                {
                    ...
                    string dbPath = Helper.GetFilePath(_env.WebRootPath, "assets/images/products", dbDetail.Image);
